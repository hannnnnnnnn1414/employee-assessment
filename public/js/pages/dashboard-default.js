...
function floatchart() {
  (function () {
    ...
    var options = {
      ...
      colors: ['#1890ff', '#52c41a', '#ff4d4f'], // biru, hijau, merah
      series: [
        {
          name: 'Dokumen Diupload',
    ...
    // Grafik 2 (kalau kamu ingin tetap punya grafik bulanan)
    var options1 = {
      chart: {
        height: 450,
        type: 'area',
      ...
      colors: ['#1890ff', '#52c41a', '#ff4d4f'], // sama: biru, hijau, merah
      series: [
        {
          name: 'Page Views',
        ...
        {
          name: 'Dokumen Ditolak',
          data: [10, 20, 15, 25, 18, 30, 22, 28, 24, 20, 26, 15]
        }
      ],
      stroke: {
        curve: 'smooth',
